...
// Instantiation of Axi Bus Interface S00_AXI
	...
	) BCP_accelerator_v2_0_S00_AXI_inst (
	...
	wire [1:0] axi_lite_fpga_status_code;

// Instantiation of Axi Bus Interface S01_AXI
	BCP_accelerator_v2_0_S01_AXI # ( 
		.C_S_AXI_DATA_WIDTH(C_S01_AXI_DATA_WIDTH),
		.C_S_AXI_ADDR_WIDTH(C_S01_AXI_ADDR_WIDTH)
	) BCP_accelerator_v2_0_S01_AXI_inst (
		...
		.status_o(axi_lite_fpga_status_code)
	);

	// Add user logic here
    assign op_indicator_led = axi_lite_cpu_op_code;
    assign fpga_status_led = axi_lite_fpga_status_code;
	// User logic ends
