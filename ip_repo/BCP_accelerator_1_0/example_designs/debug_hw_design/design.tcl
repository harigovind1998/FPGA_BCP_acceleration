...
proc create_ipi_design { offsetfile design_name } {
	...
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins BCP_accelerator_0/S00_AXI]
	...
	# Copy all address to BCP_accelerator_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/BCP_accelerator_v1_0_include.tcl"
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/BCP_accelerator_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "BCP_accelerator_v1_0_hw_${i}"
